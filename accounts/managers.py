...
class UserManager(BaseUserManager):
    def create_user(self, username=None, password=None, email=None, date_of_birth=None):
        """
    ...
    def create_superuser(self, username=None, password=None, email=None, date_of_birth=None):
        """
